...
<body>
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath}/EditUserServlet" method="post">
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				<td align="center" bgColor="#f5fafe" class="ta_01">用户角色：</td>
				<td class="ta_01" bgColor="#ffffff">
					<input type="text" name="role" class="bg" value="${u.role}" />
				</td>
				<td align="center" bgColor="#f5fafe" class="ta_01">可借阅数：</td>
				<td class="ta_01" bgColor="#ffffff">
					<input type="text" name="bnum" class="bg" value="${u.bnum}" />
				</td>
			</tr>
			<TR>
