...
<body onload="setProductCategory('${b.category}')">
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff">
					<input type="text" name="name" class="bg" value="${b.name }" />
				</td>
				<td align="center" bgColor="#f5fafe" class="ta_01">商品价格：</td>
				<td class="ta_01" bgColor="#ffffff">
					<input type="text" name="price" class="bg" value="${b.price }" />
				</td>
			</tr>
			<tr>
				<td align="center" bgColor="#f5fafe" class="ta_01">商品数量：</td>
				<td class="ta_01" bgColor="#ffffff">
					<input type="text" name="pnum" class="bg" value="${b.pnum}" />
				</td>
			...
			<TR>
				...
				<TD class="ta_01" bgColor="#ffffff" colSpan="3">
					<textarea name="description" cols="30" rows="3" style="WIDTH: 96%"> ${b.description } </textarea>
				</TD>
			</TR>
			<TR>
				<td align="center" colSpan="4" class="sep1">
					<img src="${pageContext.request.contextPath}/products/images/shim.gif">
				</td>
			</TR>
			<tr>
